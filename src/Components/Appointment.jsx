...
import BgLayer from '../assets/Layer 1.png'
                ...
                <div className="rounded-3xl  relative font-sans before:absolute before:w-full before:h-full  ">
                    ...
                    <div className="min-h-[477px] relative z-50 h-full  text-white px-[60px] py-[107px] bg-gradient-to-r from-[#020043]  to-[#0200434D] space-y-10 rounded-3xl">
                        ...
                        <div className='flex gap-4'>
                            <a href="#_" className="inline-flex items-center justify-center w-full px-7 py-3 bg-[#FFC637]  mb-2 text-[#343268] text-xl border-2 border-[#343268] rounded-xl sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                                Appointment
                                <MdArrowOutward className="ml-3 size-5 " />
                            </a>
                            <a href="#_" className="inline-flex items-center justify-center w-full px-7 py-3  mb-2 text-white text-xl border-2 border-white rounded-xl sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                                Learn More
                                <MdArrowOutward className="ml-3 size-5 " />
                            </a>
                        </div>
